...
Dowload the file [HAPPY.rds](https://github.com/yumouqiu/DS202-Spring2023/blob/main/03_tidyverse/data/HAPPY.rds) and put the file into a folder called "data" next to your Rmd file. The following command is going to load the data into your R session:
