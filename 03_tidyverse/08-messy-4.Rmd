...
HallOfFamePeople1 = HallOfFamePeople %>% filter(is.na(deathYear) == TRUE)
HallOfFamePeople2 = HallOfFamePeople %>% filter(nameFirst == "Sammy")
HallOfFamePeople3 = HallOfFamePeople %>% group_by(playerID) %>% summarise(NumberOfTry = n(), FinalInducted = max(as.numeric(inducted)) - 1)
