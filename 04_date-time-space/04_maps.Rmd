...
```{r}
getwd()
acc <- read.csv("/Users/yumouqiu/DS202-Spring2022/Practice/data/fars2016/accident.csv", stringsAsFactors = FALSE)
names(acc)
```
...
state.code = read.csv("/Users/yumouqiu/DS202-Spring2022/04_date-time-space/StateNames.csv")
names(state.code)[1] = "region"
state.code$region = tolower(state.code$region)

acc2016.mainland2 = left_join(acc2016.mainland1, state.code, 
                              by = c("STATE" = "code"))
